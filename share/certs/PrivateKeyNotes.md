...
unlocked to sign the Relay-Qt.app bundle.
...
allowing somebody to distribute a Relay-Qt.app or relay-qt-setup.exe with a valid
...
that the relay-qt.exe file inside the installer had not been tampered with.
