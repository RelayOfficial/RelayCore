...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("navajoanonsubchain-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("navajoanonsubchain-net");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("navajoanonsubchain-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "NavajoAnonSubChain " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
{"navajoanonsubchain.no-ip.biz", "navajoanonsubchain.no-ip.biz"},
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("navajoanonsubchain-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("navajoanonsubchain-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("navajoanonsubchain-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("navajoanonsubchain-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. NavajoAnonSubChain is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("navajoanonsubchain-start");
