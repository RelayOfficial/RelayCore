...
static const int LAST_POW_BLOCK = 200000; // at 30 second blocks will be about 14 days from launch

static const unsigned int MAX_BLOCK_SIZE = 1000000;
static const unsigned int MAX_BLOCK_SIZE_GEN = MAX_BLOCK_SIZE/2;
static const unsigned int MAX_BLOCK_SIGOPS = MAX_BLOCK_SIZE/50;
static const unsigned int MAX_ORPHAN_TRANSACTIONS = MAX_BLOCK_SIZE/100;
static const unsigned int MAX_TX_COMMENT_LEN_V1 = 140; // 128 bytes + extra
static const unsigned int MAX_TX_COMMENT_LEN_V2 = 512; // 512 bytes (allows for 2048 bit encryption + extra)
static const unsigned int TX_COMMENT_V2_HEIGHT = 1;
...
static const uint256 hashGenesisBlock("0000074ac96325fb3454ea03fd8160cb4706a6ce2dc4296c4bb6426b17427b2f");
static const uint256 hashGenesisBlockTestNet("0000074ac96325fb3454ea03fd8160cb4706a6ce2dc4296c4bb6426b17427b2f");
...
public:
    ...
    {
        // navajoanonsubchain: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // navajoanonsubchain: get transaction coin age
...
public:
    ...
    // navajoanonsubchain: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // navajoanonsubchain: two types of block: proof-of-work or proof-of-stake
    ...
    // navajoanonsubchain: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // navajoanonsubchain: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // navajoanonsubchain: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // navajoanonsubchain: block index flags
    enum  
    {
