...
const char * const NAVCOIN_CONF_FILENAME = "relay.conf";
const char * const NAVCOIN_PID_FILENAME = "relay.pid";
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\relay
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\relay
    // Mac: ~/Library/Application Support/relay
    // Unix: ~/.relay
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Relay";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Relay";
#else
    // Unix
    return pathRet / ".relay";
#endif
#endif
}
