...
void OptionsModel::Init(bool resetSettings)
{
    ...
    if (!settings.contains("strThirdPartyTxUrls"))
        settings.setValue("strThirdPartyTxUrls", "https://chainz.cryptoid.info/rly/tx.dws?%s.htm");
    strThirdPartyTxUrls = settings.value("strThirdPartyTxUrls", "https://chainz.cryptoid.info/rly/tx.dws?%s.htm").toString();
