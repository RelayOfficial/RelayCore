    ...
    platformStyle(platformStyle)
{
    ...
    topMenuLayout = new QVBoxLayout;
    topMenuLayout->setContentsMargins(10,0,0,10);
    topMenuLayout->setSpacing(0);
    topMenu = new QWidget();
    topMenu->setSizePolicy(QSizePolicy::Expanding, QSizePolicy::Expanding);
    topMenu->setMinimumWidth(170);
    topMenu->setMinimumHeight(600);
    topMenu->setObjectName("topMenu");
    topMenu->setStyleSheet(" background-color: #081420; border: 0px; ");
