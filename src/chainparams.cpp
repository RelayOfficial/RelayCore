...
static CBlock CreateGenesisBlock(const char* pszTimestamp, const CScript& genesisOutputScript, uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    txNew.vout[0].scriptPubKey.clear();
    txNew.strDZeel = "Relay genesis block";
...
{
    const char* pszTimestamp = "Time to revolutionize the future!";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1517620944, 6945, 0x1f00ffff, 1, 0);

	      consensus.hashGenesisBlock = genesis.GetHash();

       //   std::cout << "GEN: " << consensus.hashGenesisBlock.ToString() << std::endl;
       //   std::cout << "GEN: " << genesis.hashMerkleRoot.ToString() << std::endl;
       //   std::cout << "GEN: " << genesis.GetBlockTime() << std::endl;

        assert(consensus.hashGenesisBlock == uint256S("0xadb967a2dfe94ab1d0cbf711ea00c8f64132e5775da8bf9d3b5493cfe00f1b72"));
        assert(genesis.hashMerkleRoot == uint256S("0xb9f65ba48195f71ee9a72dec886ec60519f75ac0a8e472c4ba7c8b3fd0e97d3c"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            ( 0, uint256S("0xadb967a2dfe94ab1d0cbf711ea00c8f64132e5775da8bf9d3b5493cfe00f1b72")),
            1517620944, // * UNIX timestamp of last checkpoint block
