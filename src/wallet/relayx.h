// Copyright (c) 2017 The Relay Core developers
...
#define RELAYX_DEFAULT_INPUT_DELAY 1
#define RELAYX_DEFAULT_OUT_DELAY 10
#define RELAYX_DEFAULT_ENTROPY 4
