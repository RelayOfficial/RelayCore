/* src/config/relay-config.h.  Generated from relay-config.h.in by configure.  */
/* src/config/relay-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Relay Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Relay Core"
...
#define PACKAGE_BUGREPORT "https://github.com/relay/relay-core/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Relay Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Relay Core 1.0.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "relay"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://relay.org/"
